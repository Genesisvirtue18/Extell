...
function HomeHero() {
  return (
    ...
    >
      ...
      <div className="ui-orb-border absolute -right-24 top-16 h-72 w-72 animate-spinSlow rounded-full border" />
      <div className="ui-orb absolute -left-10 bottom-10 h-52 w-52 animate-float rounded-full blur-3xl" />
      ...
      >
        ...
        <div className="mt-10 grid max-w-3xl gap-3 sm:grid-cols-3">
          <div className="tech-panel red-wash ui-surface-1 rounded-lg p-3">
            <p className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide ui-text"><Activity size={14} className="text-[#ed2125]" /> Live Uptime Focus</p>
          </div>
          <div className="tech-panel red-wash ui-surface-1 rounded-lg p-3">
            <p className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide ui-text"><ShieldCheck size={14} className="text-accent" /> Compliance Ready</p>
          </div>
          <div className="tech-panel red-wash ui-surface-1 rounded-lg p-3">
            <p className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide ui-text"><Zap size={14} className="text-[#ed2125]" /> Critical Power</p>
          </div>
        </div>
      </motion.div>
    </section>
