    ...
    <footer className="border-t border-white/10 bg-black">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-sm text-neutral-300">Enterprise-grade power electronics and ICT infrastructure partner.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-sm text-neutral-300">sales@extellsystems.com</p>
          <p className="text-sm text-neutral-300">+1 (202) 555-0148</p>
        </div>
      </div>
