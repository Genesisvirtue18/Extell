...
function CategoryCard({ category, index = 0 }) {
  ...
  return (
    <motion.article
      whileHover={{ y: -5 }}
      className="card-lift rounded-xl border border-white/15 bg-[#141414]/90 p-6 text-white shadow-[0_14px_34px_rgba(0,0,0,0.45)]"
    >
      <div className="flex items-center justify-between gap-3">
        <p className="inline-flex rounded-md border border-white/20 bg-white/5 px-2 py-1 text-[10px] font-semibold tracking-[0.14em] text-neutral-300">
          {badge}
        </p>
